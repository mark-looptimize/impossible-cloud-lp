...
const sectionIdentifier = 'hero-section';
        ...
        <div class="mx-auto max-w-2xl">
          <div class="max-w-lg">
            ...
            <div class="mt-10 flex items-center gap-x-6">
              ...
              <!-- <a href="#" class="text-sm font-semibold leading-6 text-gray-900">${configuration.button2} <span aria-hidden="true">&darr;</span></a> -->
            </div>
          </div>
        </div>
      </div>
